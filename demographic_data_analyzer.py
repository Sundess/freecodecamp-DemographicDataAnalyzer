...
def calculate_demographic_data(print_data=True):
    ...
    # Percentage with salary >50K for advanced education and without
    ...
    # Percentage of rich people among those who work minimum hours
    ...
    rich_country_percentage = (country_salary / country_counts * 100).dropna()
